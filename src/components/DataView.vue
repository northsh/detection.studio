    ...
    <div class="h-full w-full rounded-xl bg-muted/50 flex flex-col gap-2 p-3 overflow-hidden">
        ...
        <template v-else>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div v-if="showErrorDetails && sigma?.data_loading_error"
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <button class="text-white hover:text-red-200" @click="showErrorDetails = false">×</button>
                        </div>
            ...
            <Tabs v-model="activeTab" class="flex-1 min-h-0 flex flex-col">
                ...
                <!-- Summary Tab -->
                <TabsContent class="flex-1 min-h-0 data-[state=active]:flex data-[state=active]:flex-col"
                             value="summary">
                    <Card class="p-4">
                    ...
                    <div v-else-if="sigma?.data_loading_error"
                    ...
                    <div v-else-if="sigma?.is_searching"
                ...
                <TabsContent class="flex-1 min-h-0 data-[state=active]:flex data-[state=active]:flex-col"
                    ...
                    <!-- No matches state -->
                    <div v-else-if="sigma?.is_data_loaded && !sigma?.is_searching"
                         class="flex flex-col items-center justify-center py-12">
                        <SearchIcon class="h-12 w-12 text-muted-foreground/50 mb-4"/>
                        <h3 class="text-lg font-medium">No Matches Found</h3>
                        <p class="text-sm text-muted-foreground mt-1">The current Sigma rule doesn't match any logs in
                            your dataset.</p>
                    </div>
                ...
                <!-- Raw Data Tab -->
                <TabsContent class="flex-1 min-h-0 data-[state=active]:flex data-[state=active]:flex-col" value="raw">
