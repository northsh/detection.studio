        ...
        <CardContent>
          <div class="space-y-4">
            <div class="grid gap-2">
              ...
              <Input id="default-author" v-model="defaultAuthor" placeholder="Your name or organization" />
              <p class="text-sm text-muted-foreground">This will be used as the default author in new Sigma rules</p>
            </div>
            ...
            <div class="grid gap-2">
              ...
              <Select v-model="defaultTemplate">
                ...
                <SelectContent>
                  <SelectItem v-for="template in templateOptions" :key="template.value" :value="template.value">
                    {{ template.label }}
                  </SelectItem>
                </SelectContent>
              </Select>
        ...
        <CardContent>
          <div class="space-y-4">
            ...
            <div class="grid gap-2">
              ...
              <p class="text-sm text-muted-foreground">Coming soon: Change the font size in code editors</p>
            </div>
          </div>
        </CardContent>
      </Card>
